...
<p align="center">
<img src="images/branches/rstudio-01_branch-button.png" alt="Screenshot of the set of buttons in RStudio's Git pane" width="75%"/>
</p>
...
<p align="center">
<img src="images/branches/rstudio-02_name-branch.png" alt="Screenshot of the menu that opens when you click the purple 'create branch' button in RStudio. Includes a text field for the branch name as well as a some other checkboxes/options (that can be safely left at their default settings in many cases)" width="65%"/>
</p>
...
<p align="center">
<img src="images/branches/rstudio-03_new-branch-message.png" alt="Screenshot of the text returned when you create a branch in RStudio" width="75%"/>
</p>
...
<p align="center">
<img src="images/branches/rstudio-04_new-branch-success.png" alt="Screenshot of RStudio's Git pane where it can be seen that the branch name has changed to the new branch created earlier" width="75%"/>
</p>
