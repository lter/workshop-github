...
Once you've completely finished working in your branch, you'll want to merge the content from your branch back into the "main" branch. To do this, we'll need to a GitHub operation called a "pull request".

To start this process,  **<span style="color:green">push</span>/sync all of your local commits to your GitHub repository.** Your GitHub repository will now have a brand new button titled "Compare & pull request". **Click that button.**
