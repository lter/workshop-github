...
Once you've done this, the chosen status should be visible in the metadata of the issue. If you change the status (either from the issue or from the project), it'll update here. The history of statusses of this issue will also appear in the chronological comments on the left sidebar of the issue.
