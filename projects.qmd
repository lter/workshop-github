...
![](images/projects/projects-3-example.png){fig-alt="Screenshot of an open project in 'board' view with many open issues categorized into user-defined columns"}
...
![](images/projects/projects-4-view-tabs.png){fig-alt="Screenshot of the 'project views' section of an open GitHub project" fig-align="center" width="45%"}
...
![](images/projects/projects-5-table.png){fig-alt="Screenshot of an open project in 'table' view where issues are shown in a stack instead of in separate columns"}
...
![](images/projects/projects-6-roadmap.png){fig-alt="Screenshot of an open project in 'roadmap' view where a project is shown with issues in rows ordered by the due dates defined in each"}
...
![](images/projects/projects-7a-add-from-issue.png){fig-alt="Screenshot of a new issue being created in GitHub"}
...
![](images/projects/projects-7b-add-from-issue.png){fig-alt="Screenshot of the small pop-up menu that opens when you try to add an issue to an existing project" fig-align="center" width="40%"}
...
![](images/projects/projects-8-add-from-project.png){fig-alt="Screenshot of part of a 'board' view GitHub project with the 'add item' button conspicuous at the bottom of each column" fig-align="center" width="75%"}
...
If your team is considering these three points, then adopting GitHub projects will further empower your ability to track your internal tasks over time. Feel free to consult the "Issues" page of this workshop for more information!
