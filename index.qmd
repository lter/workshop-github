...
> Lyon, N.J., Chen, A., and Brun, J. (2025). Collaborative Coding with GitHub (v2.0). Zenodo. [https://doi.org/10.5281/zenodo.16966956](https://doi.org/10.5281/zenodo.16966956)   
...
{{< include prep-steps/check_git-install_rstudio.qmd >}}

#### 6. Connect RStudio/Git and GitHub

{{< include prep-steps/connect_git-github_rstudio.qmd >}}
...
{{< include prep-steps/install_positron.qmd >}}
...
{{< include prep-steps/connect_git-github_positron.qmd >}}
