...
![](images/issues/issues-1-location-on-repo-page.png){fig-alt="Screenshot of the GitHub repository for the 'googledrive' R package with many open issues"}
...
![](images/issues/issues-2-main-page.png){fig-alt="Screenshot of the issues tab of the 'googledrive' R package"}
...
![](images/issues/issues-2b-dialogue.png){fig-alt="Screenshot of the conversation between a user and a package maintainer in a particular issue"}
...
![](images/issues/issues-3-label-example.png){fig-alt="Screenshot of several issues open on the 'googledrive' R package, each of which has more than one 'label' to help categorize issues"}
