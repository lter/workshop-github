...
![](images/issues/issues-4-create-first-issue.png){fig-alt="Screenshot of the issues tab for a repository without any issues"}

To create an issue, click the **<span style="color:green">green button</span>** and a new page will open that looks like the below.

![](images/issues/issues-5-issue-options.png){fig-alt="Screenshot of a newly-opened issue with empty fields for the title and description"}
...
![](images/issues/googledrive-issue_04-labels.png){fig-alt="Screenshot of several issues open on the 'googledrive' R package, each of which has more than one 'label' to help categorize issues"}
...
![](images/issues/issues-6-label-options.png){fig-alt="Screenshot of the dropdown that appears when adding a label (from the available set of options) to an issue"}
...
![](images/issues/issues-7-started-issue.png){fig-alt="Screenshot of an opened issue with an informative yet concise title and two labels"}
...
![](images/issues/issues-8-prepping-to-close-issue.png){fig-alt="Screenshot of the bottom of a Github issue where the purple 'close issue' button can be found"}
...
![](images/issues/issues-9-closed-issue.png){fig-alt="Screenshot of a closed GitHub issue where a purple checkmark is included in the history of the issue to indicate that it is closed"}
...
![](images/issues/issues-10-revisiting-issue-list.png){fig-alt="Screenshot of the 'issues' tab of a GitHub issue where there is one closed issue but no open ones"}

Clicking that "Closed" button will access all past issues that are now closed.

![](images/issues/issues-11-finding-closed-issues.png){fig-alt="Screenshot of the list of closed issues on a GitHub repository"}
