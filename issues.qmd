...
<p align="center">
<img src="images/issues/issues-1-location-on-repo-page.png" alt="Screenshot of the GitHub repository for the 'googledrive' R package with many open issues" width="100%" />
</p>
...
<p align="center">
<img src="images/issues/issues-2-main-page.png" alt="Screenshot of the issues tab of the 'googledrive' R package" width="100%" />
</p>
...
<p align="center">
<img src="images/issues/issues-2b-dialogue.png" alt="Screenshot of the conversation between a user and a package maintainer in a particular issue" width="100%" />
</p>
...
<p align="center">
<img src="images/issues/issues-4-create-first-issue.png" alt="Screenshot of the issues tab for a repository without any issues" width="100%" />
</p>

To create an issue, click the **<span style="color:green">green button</span>** and a new page will open that looks like the below.

<p align="center">
<img src="images/issues/issues-5-issue-options.png" alt="Screenshot of a newly-opened issue with empty fields for the title and description" width="100%" />
</p>
...
<p align="center">
<img src="images/issues/issues-3-label-example.png" alt="Screenshot of several issues open on the 'googledrive' R package, each of which has more than one 'label' to help categorize issues" width="100%" />
</p>
...
<p align="center">
<img src="images/issues/issues-6-label-options.png" alt="Screenshot of the dropdown that appears when adding a label (from the available set of options) to an issue" width="100%" />
</p>
...
<p align="center">
<img src="images/issues/issues-7-started-issue.png" alt="Screenshot of an opened issue with an informative yet concise title and two labels" width="100%" />
</p>
...
<p align="center">
<img src="images/issues/issues-8-prepping-to-close-issue.png" alt="Screenshot of the bottom of a Github issue where the purple 'close issue' button can be found" width="100%" />
</p>
...
<p align="center">
<img src="images/issues/issues-9-closed-issue.png" alt="Screenshot of a closed GitHub issue where a purple checkmark is included in the history of the issue to indicate that it is closed" width="100%" />
</p>
...
<p align="center">
<img src="images/issues/issues-10-revisiting-issue-list.png" alt="Screenshot of the 'issues' tab of a GitHub issue where there is one closed issue but no open ones" width="100%" />
</p>

Clicking that "Closed" button will access all past issues that are now closed.

<p align="center">
<img src="images/issues/issues-11-finding-closed-issues.png" alt="Screenshot of the list of closed issues on a GitHub repository" width="100%" />
</p>
