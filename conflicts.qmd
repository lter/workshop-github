...
![](images/graphics/git-conflict-workflow.png){fig-alt="Graphic indicating the process of resolving a conflict when one occurs. After the initial conflict (caused when pushing a file from your machine differs from the GitHub version of that file), the combined file is auto-generated on your machine and you must then resolve the changes manually. These changes can then be committed and pushed up to GitHub" fig-align="center" width="60%"}
...
![](images/conflicts/rstudio-01_conflict.png){fig-alt="Screen capture of RStudio message warning about a merge conflict" fig-align="center" width="80%"}
...
![](images/conflicts/rstudio-02_pull-conflict.png){fig-alt="Screen capture of RStudio message warning about post-merge conflict auto-merge failure" fig-align="center" width="80%"}
...
![](images/conflicts/rstudio-03_auto-merge.png){fig-alt="Screen capture of RStudio where a conflicted file has been auto-merged by GitHub"}
...
![](images/conflicts/rstudio-04_repair-script.png){fig-alt="Screen capture of a script in RStudio where the merge conflict lines have been removed"}
...
![](images/conflicts/rstudio-05_commit-repairs.png){fig-alt="Screen capture of a commit in RStudio with the message 'fixing conflict'" fig-align="center" width="80%"}
...
![](images/conflicts/rstudio-06_push.png){fig-alt="Screen capture of a script in RStudio where the merge conflict lines have been removed"}
...
![](images/conflicts/rstudio-07_fixed.png){fig-alt="Screen capture of RStudio with an open script"}
...
![](images/conflicts/positron-01_conflict.png){fig-alt="Screen capture of Positron message warning about a merge conflict"}
...
![](images/conflicts/positron-02_repair-script.png){fig-alt="Screen capture of a script in Positron without merge conflict lines" fig-align="center" width="60%"}
...
![](images/conflicts/positron-03_commit-repairs.png){fig-alt="Screen capture of a commit in Positron with the message 'fixing conflict'" fig-align="center" width="60%"}
...
![](images/conflicts/positron-04_sync.png){fig-alt="Screen capture of a script in Positron where the merge conflict lines have been removed" fig-align="center" width="60%"}
...
![](images/conflicts/positron-05_fixed.png){fig-alt="Screen capture of Positron with an open script" fig-align="center" width="60%"}
