...
![](images/graphics/git-workflow.png){fig-alt="Graphic of a white rectangle on top of a blue square. The white rectangle has a happy cloud image and is labeled 'GitHub' while the blue square has an emoji-style laptop. Numbered steps start at the bottom left and work towards the top right as follows: '1-make changes', '2-stage changes', '3-retrieve latest from GitHub', and '4-put in GitHub'" fig-align="center" width="70%"}
...
![](images/graphics/git-vocabulary.png){fig-alt="Graphics demonstrating a clone (copy entire folder from GitHub to a computer), a commit (putting local changes into the staging area), a pull (overwriting local copies with GitHub versions of the same), and a push (overwriting GitHub versions of files with the committed local versions)" fig-align="center" width="70%"}
...
![](images/clone/rstudio-01_repo-home.png){fig-alt="Screen capture of the home page of a GitHub repository named 'git-practice'"}

Once you are there, **click the "Code"** button then, in the resulting dropdown menu, **copy the link under the "HTTPS" tab.**

![](images/clone/rstudio-02_repo-code-tab.png){fig-alt="Screen capture of the menu that appears in a GitHub repository when someone clicks the 'code' button"}
...
![](images/clone/rstudio-03_start.png){fig-alt="Screenshot of RStudio when no project or scripts are open"}

Once you have clicked that button in order to open its dropdown menu, **click "New Project..."**

![](images/clone/rstudio-04_new-proj.png){fig-alt="Screenshot of the menu that appears when someone clicks 'Project: (None)' in RStudio and hovers over the 'New Project...' button" fig-align="center" width="40%"}

In the resulting pop-up window, **select "Version Control".**

![](images/clone/rstudio-05_version-control.png){fig-alt="Screenshot of a menu with three options: 'new directory', 'existing directory', and 'version control'" fig-align="center" width="50%"}

In the next page of the pop-up menu, **select "Git".**

![](images/clone/rstudio-06_git.png){fig-alt="Screenshot of a menu with two options: 'git' and 'subversion'" fig-align="center" width="50%"}
...
![](images/clone/rstudio-07_repo-details.png){fig-alt="Screenshot of a menu with three open text fields, one for the 'repository URL', one for 'project directory name' and one for 'create project as subdirectory of'" fig-align="center" width="50%"}
...
![](images/clone/rstudio-08_cloned.png){fig-alt="Screen capture of the RStudio home page after cloning has been completed"}
...
![](images/clone/positron-01_repo-home.png){fig-alt="Screen capture of the home page of a GitHub repository named 'git-practice'"}
...
![](images/clone/positron-02_start.png){fig-alt="Screen capture of the home page of Positron"}

In the resulting dropdown menu, **select "New Folder from Git..."**.

![](images/clone/positron-03_new-folder.png){fig-alt="Screen capture of the Positron with the folder dropdown menu in the top right corner expanded to reveal recent folders" fig-align="center" width="40%"}
...
![](images/clone/positron-04_repo-details.png){fig-alt="Screen capture of the Positron pop-up menu where a GitHub repository's details may be entered in order to clone it locally" fig-align="center" width="50%"}
...
![](images/clone/positron-05_cloned.png){fig-alt="Screen capture of the Positron home page after cloning has been completed"}
...
![](images/commit/rstudio-01_new-file.png){fig-alt="Screenshot of RStudio with an open script and several uncommitted changes identified in the 'Git' pane. Lack of commit is identified by double yellow squares containing a question mark"}
...
![](images/graphics/rstudio-icons.png){fig-alt="A legend of five icons RStudio uses to indicate Git status of a file. Yellow question mark = untracked (file not tracked by Git). Green 'A' = added (file marked to start tracking). Blue 'M' = modified (tracked file with changes). Red 'D' = deleted (tracked file that was deleted). Purple 'R' = renamed (tracked file that was renamed)" fig-align="center" width="50%"}
...
![](images/commit/rstudio-02_diff.png){fig-alt="Screenshot of the 'diff' button--circled in red--in the 'Git' pane of RStudio" fig-align="center" width="80%"}
...
![](images/commit/rstudio-03_commit.png){fig-alt="Screenshot of the commit menu of RStudio where one file has been staged and an informative commit message has been entered" fig-align="center" width="80%"}
...
![](images/commit/rstudio-04_ahead-of-origin.png){fig-alt="Screenshot of the success message after a commit has been made"}
...
![](images/commit/rstudio-05_pull.png){fig-alt="Screenshot of the message returned when you pull from a repository where you are already up-to-date" fig-align="center" width="80%"}
...
![](images/commit/rstudio-06_push.png){fig-alt="Screenshot of the message returned when you push a commit to a repository successfully" fig-align="center" width="80%"}
...
![](images/commit/rstudio-07_updated-repo.png){fig-alt="Screenshot of a GitHub repository home page"}
...
![](images/commit/positron-01_new-file.png){fig-alt="Screenshot of Positron with an open script untracked by Git with one uncommitted change. Lack of commit is identified by red number '1' in the left sidebar"}
...
![](images/commit/positron-02_diff.png){fig-alt="Screenshot of the source control pane of Positron showing one file with changes" fig-align="center" width="70%"}
...
![](images/commit/positron-03_commit.png){fig-alt="Screenshot of the commit menu of Positron where one file has been staged and an informative commit message has been entered" fig-align="center" width="70%"}
...
![](images/commit/positron-04_ahead-of-origin.png){fig-alt="Screenshot of the source control pane in Positron where the 'sync changes' button is active" fig-align="center" width="70%"}
...
![](images/commit/positron-03b_other-git-actions.png){fig-alt="Screen capture of Positron source control pane with dropdown menu of Git actions open and visible" fig-align="center" width="70%"}
...
![](images/commit/positron-05_sync-alert.png){fig-alt="Screen capture of Positron warning about what 'sync changes' will do" fig-align="center" width="40%"}
...
![](images/commit/positron-06_sync.png){fig-alt="Screen capture of Positron source control pane when there are no new changes to be committed or synced" fig-align="center" width="70%"}
...
![](images/commit/positron-07_updated-repo.png){fig-alt="Screenshot of a GitHub repository home page"}
