...
![](images/browser/browser-01_github-home.png){fig-alt="Screenshot of the GitHub landing page when you go to 'github.com' and are not signed in"}

Log in with your GitHub account that you should have created prior to this workshop.

<p align="center">
![](images/browser/browser-02_github-login.png){fig-alt="Screenshot of the pop-up that appears when you click 'sign in' on GitHub" width="40%"}
</p>

Once you've logged in, you should see something like this:

![](images/browser/browser-03_github-signed-in.png){fig-alt="Screenshot of GitHub homepage after you've signed in"}
...
![](images/browser/browser-04_profile-light.png){fig-alt="Screenshot of the landing page on a particular GitHub profile"}
...
![](images/browser/browser-05_appearance-setting.png){fig-alt="Screenshot of the 'appearance' section of a GitHub user's settings area"}
...
![](images/browser/browser-06_repos.png){fig-alt="Screenshot of the 'repositories' tab of a user on GitHub"}
...
![](images/browser/browser-07_repo-structure.png){fig-alt="Screenshot of the landing page for a particular repository. A blue rectangle surrounds the information about the most recent commit, a green box surrounds the 'last modified' date for all files in the repository (on the right side of the page), and a red box surrounds the the file and folder names (left side of the page)"}
...
![](images/browser/browser-08_repo-history.png){fig-alt="Screenshot of the commit history of a single repository. Shows a list of commits in reverse chronological order (i.e., most recent on top) along with their dates and their respective commit messages"}

And finally, if we examine one of the changes made on April 25, we can see exactly what was changed in each file:

![](images/browser/browser-09_commit-diff.png){fig-alt="Screenshot of the changes made to a single file in one commit. Added lines are in green while deleting lines are in red"}
...
![](images/browser/browser-10_edit-file.png){fig-alt="Screenshot of a file being viewed in GitHub with a yellow circle around the pencil icon on the top right corner of the file. The pencil has a hovering message above it labeled 'edit this file'"}
...
![](images/browser/browser-11_add-file.png){fig-alt="Screenshot of a GitHub repository landing page where the 'add file' button has been clicked and a yellow circle surrounds the 'create new file' and 'upload files' buttons in the sub-menu that action created"}
...
![](images/browser/new-repo-01_profile.png){fig-alt="Screenshot of the 'repositories' landing page of a particular GitHub user"}
...
![](images/browser/new-repo-03_home.png){fig-alt="Screenshot of a new repository containing only a README file"}
...
![](images/browser/new-repo-04_collab-settings.png){fig-alt="Screenshot of the 'settings' pane of the new repository shown in the prior image"}
...
![](images/browser/new-repo-05_collab-search.png){fig-alt="Screenshot of the dialogue box prompting the viewer to enter names or emails of people to add as collaborators" fig-align="center" width="60%"}
