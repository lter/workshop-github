...
![](images/readme/readme-1-example.png){fig-alt="Screenshot of the full README on the GitHub repository of the 'lterpalettefinder' R package"}
...
![](images/readme/readme-2-example-home.png){fig-alt="Screenshot of the files in the 'lterpalettefinder' R package GitHub repository showing that there is both a README.md and a README.Rmd"}
...
![](images/readme/readme-3-example-raw-1.png){fig-alt="Screenshot of the 'raw' view of the top half of the README.Rmd file from the previous screenshot"}

![](images/readme/readme-4-example-raw-2.png){fig-alt="Screenshot of the 'raw' view of the bottom half of the README.Rmd file from the previous screenshot"}
