...
<p align="center">
<img src="images/forks/git-fork-workflow.png" alt="Graphic of the workflow when using forks. Begins by forking someone else's repository then working in your fork as you normally would" width="75%"/>
</p>
...
<p align="center">
<img src="images/forks/forks-2-name-fork.png" alt="Screenshot of the GitHub interface for making a fork (where the repository can be renamed and have a description added)" width="100%" />
</p>
...
<p align="center">
<img src="images/forks/forks-3-fork-landing-page.png" alt="Screenshot of the forked repository owned by a different owner than the original repository" width="100%" />
</p>
