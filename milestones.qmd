...
![](images/milestones/milestones-1-example.png){fig-alt="Screenshot of an open milestone accessed from the 'milestones' toggle within the 'issues' tab of a particular GitHub repository"}
...
![](images/milestones/milestones-2-details.png){fig-alt="Screenshot of the inside of a GitHub milestone where open issues attached to that milestone are displayed"}
...
![](images/milestones/milestones-3-get-started.png){fig-alt="Screenshot of the issues tab of a GitHub repository where the 'milestones' button in the top right is surrounded by a red circle"}

Then click on either the "New milestone" or "Create a milestone" button if you haven't created a milestone yet. 

![](images/milestones/milestones-4-new-milestone.png){fig-alt="Screenshot of the 'milestones' toggle of a GitHub repository where no milestones have yet been created"}
...
![](images/milestones/milestones-5-fill-info.png){fig-alt="Screenshot of the creation phase for a new GitHub milestone with an open field for a title and description as well as an optional due date field"}

You can always go back to the "Milestones" page and click "Edit" if you need to edit the title, due date, or description.

![](images/milestones/milestones-6-edit.png){fig-alt="Screenshot of an open milestone where the 'edit' button is underlined in red" fig-align="center" width="100%"}

To add issues/pull requests to your milestone, you can click on your milestone and add them directly there. 

![](images/milestones/milestones-7-add.png){fig-alt="Screenshot of GitHub where a milestone that has no issues displays a central 'create new issue' button"}
...
![](images/milestones/milestones-8-add-more.png){fig-alt="Screenshot of the issues tab in GitHub where you can filter issues by which milestone(s) an issue has been added to"}
