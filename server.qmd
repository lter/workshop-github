...
![](images/server/server-login-1-console.png){fig-alt="" fig-align="center" width="85%"}
...
![](){fig-alt="" fig-align="center" width="100%"}
...
![](images/server/server-login-3-invite-email.png){fig-alt="" fig-align="center" width="85%"}
...
![](images/server/server-upload-1.png){fig-alt="" fig-align="center" width="75%"}
...
![](images/server/server-upload-2.png){fig-alt="" fig-align="center" width="75%"}

You can also download data via the RStudio interface. To download a file, check the box next to it in the "Files" pane.

![](images/server/server-download-1.png){fig-alt="" fig-align="center" width="75%"}
...
![](images/server/server-download-2.png){fig-alt="" fig-align="center" width="75%"}
...
![](images/server/server-download-3.png){fig-alt="" fig-align="center" width="65%"}
...
![](images/server/server-cyberduck-1.png){fig-alt=""}
...
![](images/server/server-cyberduck-2.png){fig-alt="" fig-align="center" width="85%"}
...
![](images/server/server-cyberduck-3.png){fig-alt="" fig-align="center" width="85%"}
