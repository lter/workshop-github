...
![](images/server/server-login-3-invite-email.png){fig-alt="Screenshot of an email with the subject line 'Account on Aurora' and body text including a server host link, usernae, and password (covered by a red box)" fig-align="center" width="85%"}
