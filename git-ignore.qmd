...
![](images/ignore/rstudio-01_untracked-csv.png){fig-alt="Screen capture of RStudio where the Git pane shows an untracked file named 'data.csv'"}
...
![](images/ignore/rstudio-02_files.png){fig-alt="Screen capture of RStudio with the 'Files' pane open"}
...
![](images/ignore/rstudio-03_ignore-open.png){fig-alt="Screen capture of RStudio with the R template '.gitignore' from GitHub open"}
...
![](images/ignore/rstudio-04_ignore-unsaved.png){fig-alt="Screen capture of RStudio with the R template '.gitignore' from GitHub open and edited but with unsaved changes"}
...
![](images/ignore/rstudio-05_ignore-saved.png){fig-alt="Screen capture of RStudio where the Git pane shows un-committed edits to the '.gitignore'"}
...
![](images/ignore/positron-01_untracked-csv.png){fig-alt="Screen capture of Positron where the source control pane shows an untracked file named 'data.csv'" fig-align="center" width="50%"}
...
![](images/ignore/positron-02_files.png){fig-alt="Screen capture of Positron with the 'Explorer' pane open" fig-align="center" width="50%"}
...
![](images/ignore/positron-03_ignore-open.png){fig-alt="Screen capture of Positron with the R template '.gitignore' from GitHub open" fig-align="center" width="50%"}
...
![](images/ignore/positron-04_ignore-unsaved.png){fig-alt="Screen capture of Positron with the R template '.gitignore' from GitHub open and edited but with unsaved changes" fig-align="center" width="50%"}
...
![](images/ignore/positron-05_ignore-saved.png){fig-alt="Screen capture of Positron where the Git pane shows un-committed edits to the '.gitignore'" fig-align="center" width="50%"}
